    ...
    <div class="md-layout md-gutter md-alignment-center">
      <div class="join md-layout-item  md-layout md-gutter">
        ...
        <div class="md-layout-item txt">
          <TextCard :content="elc.content" :position="elc.position" />
        </div>
      </div>
    </div>
    <div class="md-layout md-gutter md-alignment-center">
